...
If you are not already using semantic-ui-react in your, be sure to include `import 'semantic-ui-css/semantic.min.css'` in the entry point of your react app.
